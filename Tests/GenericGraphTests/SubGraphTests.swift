...
final class SubGraphTests: XCTestCase {
    ...
    func test_subgraphCreation() throws {
        ...
        let node2 = graph.addNode(value: "node2")
        try graph.addEdge(node0.nodeNumber, node1.nodeNumber, value: "edge01")
        try graph.addEdge(node0.nodeNumber, node2.nodeNumber, value: "edge02")
        try graph.addEdge(node1.nodeNumber, node0.nodeNumber, value: "edge10")
        try graph.addEdge(node1.nodeNumber, node2.nodeNumber, value: "edge12")
        try graph.addEdge(node2.nodeNumber, node0.nodeNumber, value: "edge20")
        try graph.addEdge(node2.nodeNumber, node1.nodeNumber, value: "edge21")
    ...
    func test_subgraphInheritsBaseEdgeDeletion() throws {
        ...
        let node1 = graph.addNode(value: "node1")
        let node2 = graph.addNode(value: "node2")
        let edge01 = try graph.addEdge(node0.nodeNumber, node1.nodeNumber, value: "edge01")
        try graph.addEdge(node0.nodeNumber, node2.nodeNumber, value: "edge02")
        try graph.addEdge(node1.nodeNumber, node0.nodeNumber, value: "edge10")
        try graph.addEdge(node1.nodeNumber, node2.nodeNumber, value: "edge12")
        try graph.addEdge(node2.nodeNumber, node0.nodeNumber, value: "edge20")
